...
class UpdatePostScreen extends StatelessWidget {
  ...
  UpdatePostScreen({required this.index, required this.postModle}) {
    titleTextEditingController.text = postModle.title!;
    bodyTextEditingController.text = postModle.body!;
  }
